...
StarRating.prototype.init = function() {
  ...
  document.querySelector('#add-rating').addEventListener('mouseleave', this.leaveStarListener.bind(this));
};
...
/**
 * This method is fired when the user leaves the #add-rating element, effectively removing all hover states.
 */
